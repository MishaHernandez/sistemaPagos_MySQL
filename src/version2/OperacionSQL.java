...
class OperacionSQL {
    ...
    public void insertarPago(JTextField txtid, JTextField txtfecha, JTextField txtobserv, JTextField txtidalumno) throws SQLException{
    ...
    public void insertarDetalleP(JTextField txtid, JTextField txtidpago, JTextField txtmonto) throws SQLException{
        String id, idpago, monto;
        //obtener texto del formulario llenado
        id = txtid.getText();
        idpago = txtidpago.getText();
        monto = txtmonto.getText();
    ...
    public void editarPago(JTextField txtid, JTextField txtfecha, JTextField txtobserv, JTextField txtidalumno) throws SQLException{
        String id, fecha, observ, idalumno;
        //obtener texto del formulario
        id = txtid.getText();
        fecha = txtfecha.getText();
    ...
    public void editarDetalleP(JTextField txtid, JTextField txtidpago, JTextField txtmonto) throws SQLException{
        String id, idpago, monto;
        //obtener texto del formulario
        id = txtid.getText();
        idpago = txtidpago.getText();
